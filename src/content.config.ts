...
export const collections = { hero, "maison-hero": maisonHero, "maison-about": maisonAbout, founders, services, testimonials, collection, partners, "visit-cta": visitCta, footer };
