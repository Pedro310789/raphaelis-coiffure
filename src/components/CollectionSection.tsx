  ...
  return (
    <section className="bg-surface">
      <div className="max-w-[1440px] mx-auto px-5 lg:px-[72px] py-16 lg:py-[96px]">
        {/* Heading */}
        <FadeIn className="flex flex-col items-center gap-4 lg:gap-6 mb-12 lg:mb-24">
        ...
        <div className="flex flex-col gap-10 lg:gap-14 items-center">
          <div ref={ref} className="grid grid-cols-1 lg:grid-cols-4 gap-6 w-full">
          ...
          <FadeIn delay={0.3}>
            <a
              ...
              className="border border-heading h-12 flex items-center justify-center px-8 font-sans text-[13px] lg:text-[14px] text-heading uppercase tracking-[0.42px] leading-[1.2] hover:bg-heading hover:text-white transition-colors duration-300"
            >
              {collection.cta}
            </a>
          </FadeIn>
